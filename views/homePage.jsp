...
<!-- 							<li><a href="myProfilesuccess" data-toggle="tab">My Profile</a></li> -->
							<li><a href='<c:url value="myProfilesuccess"><c:param name="merchantId" value="${pageContext.request.userPrincipal.name}"/></c:url>' data-toggle="tab">MyProfile</a></li>
						</ul>
